            ...
            <div className="card-body">
                <form onSubmit={(event) => guardar(event)}>
                    <div className="row justify-content-center">
                        <div className="col-3">
                            <label className="col-12 text-left">Curso:  <small class="text-muted">(requerido)</small></label>
                            <select 
                                key={0} 
                                value={alumnoCurso.curso_id} 
                                className="form-control" 
                                aria-label=".form-select-lg example" 
                                onChange={(event) => {handleOnChange(event, 'curso_id') }}>
